...
const tick = () =>
{
    ...
    const objectsToTestForMouse = [object1, object2, object3]
    const mouseIntersects = mouseRaycaster.intersectObjects(objectsToTestForMouse)

    if(mouseIntersects.length) {
        if(currentIntersect === null) {
            console.log('mouse enter')
        }
        currentIntersect = mouseIntersects[0]
    } else {
        if(currentIntersect !== null) {
